...
select = st.sidebar.selectbox("Select",("James Bond", "Objectives", "Dataset", "Datasets Cleaning & Challenges", "Model Selection", "Model Evaluation", "Phase 2", "Random Forest Code"), 3)
